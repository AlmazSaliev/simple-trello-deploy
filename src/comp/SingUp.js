  ...
  function onchang(e) {
    ...
    if (e.target.name === "email") {
      setValue({
        ...
        proverkaEmail: (value.proverkaEmail =
          getValue.trim() !== "" && getValue.length > 3),
        enterEmail: true,
      });
    }
    if (e.target.name === "password") {
      setValue({
        ...
        proverkaPassword: (value.proverkaPassword =
          getValue.trim() !== "" && getValue.length > 6),
        enterPassword: true,
      });
    }
  }
  ...
  return (
    <div className="cont-login">
      <img
        ...
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Trello-logo-blue.svg/468px-Trello-logo-blue.svg.png"
        alt="logo"
      />
          ...
          <div className="form-btn">
            ...
            <div>
              <button className="btn btn-plus">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Google_%22G%22_Logo.svg/36px-Google_%22G%22_Logo.svg.png"
                  alt="logo"
                />
                Войти через Google
              </button>
              <button className="btn btn-plus">
                <img
                  src="https://www.pngkey.com/png/detail/331-3319083_microsoft-logo-icon-png-transparent-icon-microsoft-logo.png"
                  alt="logo"
                />
